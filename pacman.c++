class PacMan(); {
  ...
  entityIdentify(entityIconGhost1.png)= @.GhostIcon.drawable{drawableIcons.Icons.Ghost1Icon};
  entityIdentify(entityIconGhost2.png)= @.GhostIcon.drawable{drawableIcons.Icons.Ghost2Icon};
  entityIdentify(entityIconGhost3.png)= @.GhostIcon.drawable{drawableIcons.Icons.Ghost3Icon};
  entityIdentify(entityIconGhost4.png)= @.GhostIcon.drawable{drawableIcons.Icons.Ghost4Icon};
